...
import { decodeBinary } from '@/lib/binary';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 py-6">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 className="text-3xl font-headline font-bold">{t('tools.binary_decode.name')}</h1>
          <p className="text-muted-foreground">{t('tools.binary_decode.description')}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        <Card className="border-border shadow-lg">
          ...
          <CardContent className="space-y-4">
            <Textarea
              placeholder="Paste your Binary string here (e.g., 01001000 01001001)..."
