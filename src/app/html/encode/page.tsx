...
import { encodeHtml } from '@/lib/html-entities';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 py-6">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 className="text-3xl font-headline font-bold">{t('tools.html_encode.name')}</h1>
          <p className="text-muted-foreground">{t('tools.html_encode.description')}</p>
        </div>
      </div>
