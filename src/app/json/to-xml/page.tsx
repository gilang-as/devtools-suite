...
import { jsonToXml } from '@/lib/xml-json';
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 py-6">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 className="text-3xl font-headline font-bold">{t('tools.json_to_xml.name')}</h1>
          <p className="text-muted-foreground">{t('tools.json_to_xml.description')}</p>
        </div>
      </div>
          ...
          <CardContent className="flex-1 flex flex-col p-0 overflow-hidden">
            <div className="flex flex-1 min-h-[450px] border-t bg-secondary/10 overflow-hidden">
              ...
              <div className="flex-1 overflow-auto">
                <Textarea
                  placeholder='{ "item": { "@attributes": { "id": "1" }, "#text": "Hello" } }'
