...
import { tomlToJson } from '@/lib/toml';
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 py-6">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 className="text-3xl font-headline font-bold">{t('tools.toml_to_json.name')}</h1>
          <p className="text-muted-foreground">{t('tools.toml_to_json.description')}</p>
        </div>
      </div>
        ...
        <Card className="flex-1 border-border shadow-lg flex flex-col overflow-hidden">
          <CardHeader className="flex flex-row items-center justify-between pb-4">
            ...
            <div className="flex gap-2">
              <input type="file" accept=".toml,.txt" className="hidden" ref={fileInputRef} onChange={handleFileUpload} />
          ...
          <CardContent className="flex-1 flex flex-col p-0 overflow-hidden">
            <div className="flex flex-1 min-h-[450px] border-t bg-secondary/10 overflow-hidden">
              ...
              <div className="flex-1 overflow-auto">
                <Textarea
                  placeholder='title = "TOML Example"&#10;[owner]&#10;name = "Tom Preston-Werner"'
