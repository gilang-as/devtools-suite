        ...
        <DialogHeader className="p-0 border-b">
          ...
          <div className="flex items-center gap-4 px-6 h-16">
            ...
            <Input
              ...
              className="border-none focus-visible:ring-0 text-lg p-0 h-full bg-transparent placeholder:text-muted-foreground/40 shadow-none hover:bg-transparent focus:bg-transparent"
              value={query}
